...
function addGamesToPage(games) {
  ...
  for (let i = 0; i < games.length; i++) {
    ...
    const display = `<div class="game-info">
...
const displayBackers = `${numBackers.toLocaleString("en-US")}`;
contributionsCard.innerHTML = displayBackers;
...
const displayStr = `A total of ${moneyRaised.toLocaleString(
  "en-US"
)} has been raised for ${GAMES_JSON.length}. Currently ${numUnfunded} ${
